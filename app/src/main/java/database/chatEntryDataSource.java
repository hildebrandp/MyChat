...
public class chatEntryDataSource {
    ...
    public chatDbEntry createChatEntry(long CHAT_ID, long CHAT_SENDER_ID,long CHAT_RECIEVER_ID,String CHAT_MESSAGE, String CHAT_READ, String CHAT_DATE, String CHAT_ISSEND) {
        ...
        Cursor cursor = chatdatabase.query(SQLiteHelper.TABLE_CHAT, allColumnsChat, null, null, null, null, null);
        cursor.moveToFirst();
